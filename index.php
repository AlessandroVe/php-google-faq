            ...
            "answers" =>[
                ...
                <ol>
                    <li>
                        ...
                        <span>a.  </span> Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.<br>
                        <span>b.  </span> Google LLC, con sede negli Stati Uniti, per il resto del mondo.<br>
                    </li>
                    <li>
